...
function Button({ labell, className, text, ...props }) {
    return (
        <>
         ...
         transition-all duration-150 ${className} transition-all duration-300 hover:shadow-[6px_6px_0_#452215] hover:-translate-y-1 mx-auto`}
                {...props}
            >
